...
function displayCounterOnLoad() {
  ...
  for (var i = 0; i < $('.piece').length; i++) {
    ...
    for (var j = 0; j < $('.piece').eq(i).find('.part').length; j++) {
      var num = $('.piece').eq(i).find('.part').find(':checked')[j].value;
      sum = sum + Number(num); // console.log('i',i,'j',j);
    }

    $('.piece').eq(i).find('.counter')[0].innerHTML = "\u30D7\u30EC\u30A4\u30E4\u30FC".concat(sum, "\u4EBA/\u30E1\u30F3\u30D0\u30FC").concat(limit, "\u4EBA\u4E2D");
  }
}
